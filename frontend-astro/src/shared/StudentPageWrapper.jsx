  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: "40px 24px" }} className="fade-in">
      <div style={{ marginBottom: 40, display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 }}>
        <div style={{ flex: 1 }}>
          <a href="/students" style={{ color: STUDENT_BRAND.accent, textDecoration: "none", fontSize: 14, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 16, padding: "6px 14px", borderRadius: 8, border: `1px solid ${STUDENT_BRAND.accent}30`, background: `${STUDENT_BRAND.accent}10` }}>
            ← Student Zone
          </a>
