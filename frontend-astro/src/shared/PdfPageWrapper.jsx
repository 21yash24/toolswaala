    ...
    <div className="fade-in">
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ display: "flex", gap: 8, fontSize: 13, marginBottom: 32 }}>
          ...
          <a href="/pdf-tools" style={{ color: PDF_BRAND.accent, textDecoration: "none", fontWeight: 600 }}>PDF Tools</a>
          <span style={{ color: BRAND.textSecondary }}>/</span>
              ...
              <div style={{ background: BRAND.surfaceCard, borderRadius: 20, border: `1px solid ${BRAND.border}`, padding: 24, position: "sticky", top: 100 }}>
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  {PDF_TOOLS.filter(t => t.path !== location.pathname).map(tool => (
                    <a key={tool.id} href={tool.path} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", borderRadius: 12, background: "rgba(255,255,255,0.03)", border: `1px solid ${BRAND.border}`, textDecoration: "none", transition: "border-color 0.2s" }}
