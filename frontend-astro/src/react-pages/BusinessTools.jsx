...
import { StudentHome, CgpaCalculator, AttendanceCalc, PercentageCalc, PomodoroTimer, BonafideCertificate, NocGenerator, ResumeBuilder, SopGenerator, ScholarshipFinder, StudyPlanner, WordCounter, AgeCalculator, YtThumbnailDownloader, JobFinder } from "./students";
...
import { PdfHome, PdfCompressor, ImageToPdf, PdfToJpg, MergePdf, SplitPdf, ImageCompressor, WordToPdf, WatermarkPdf, PdfToWord } from "./pdf";
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div className="nav-desktop-links" style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <a href="/" style={{ padding: "8px 18px", fontSize: 13, borderRadius: 10, border: `1px solid ${BRAND.primary}40`, background: location.pathname === "/" ? BRAND.primary : "transparent", color: location.pathname === "/" ? "white" : BRAND.text, textDecoration: "none", fontWeight: 700 }}>💼 Business</a>
            <a href="/pdf-tools" style={{ padding: "8px 18px", fontSize: 13, borderRadius: 10, border: `1px solid ${PDF_BRAND.accent}40`, background: location.pathname.includes("/pdf-tools") ? PDF_BRAND.accent : "transparent", color: location.pathname.includes("/pdf-tools") ? "white" : BRAND.text, textDecoration: "none", fontWeight: 700 }}>📄 PDF Tools</a>
            <a href="/blog" style={{ padding: "8px 18px", fontSize: 13, borderRadius: 10, border: `1px solid ${BRAND.primary}40`, background: location.pathname.startsWith("/blog") ? BRAND.primary : "transparent", color: location.pathname.startsWith("/blog") ? "white" : BRAND.text, textDecoration: "none", fontWeight: 700 }}>📝 Blog</a>
            <a href="/students" style={{ padding: "8px 18px", fontSize: 13, borderRadius: 10, border: `1px solid ${STUDENT_BRAND.accent}40`, background: location.pathname.startsWith("/students") || ["/cgpa","/attendance","/percentage","/pomodoro"].some(p => location.pathname.includes(p)) ? STUDENT_BRAND.accent : "transparent", color: location.pathname.includes("/students") ? "white" : BRAND.text, textDecoration: "none", fontWeight: 700 }}>🎓 Students</a>
          </div>
        ...
        <div style={{ background: BRAND.surfaceCard, borderBottom: `1px solid ${BRAND.border}`, padding: "16px 0", maxHeight: "70vh", overflowY: "auto" }} className="fade-in">
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 16, overflowX: "auto", paddingBottom: 8 }}>
              <a href="/" onClick={() => setMenuOpen(false)} style={{ padding: "10px 20px", fontSize: 14, borderRadius: 10, border: `1px solid ${BRAND.primary}40`, background: location.pathname === "/" ? BRAND.primary : "transparent", color: location.pathname === "/" ? "white" : BRAND.text, textDecoration: "none", fontWeight: 700, whiteSpace: "nowrap" }}>💼 Business</a>
...
export function PageWrapper({ title, hindi, children }) {
  useEffect(() => {
...
// HomePage moved to its own file HomePage.jsx to optimize bundle size.

// ============================================================
// TOOLS (VERBATIM LOGIC FROM toolswaala.jsx)
// ============================================================

export function UpiTool() {
...
export function GstinVerifyTool() {
          ...
          <Routes>
            ...
            <Route path="/bonafide-certificate" element={<StudentPageWrapper title="Bonafide Certificate" hindi="बोनाफाइड सर्टिफिकेट">
              ...
              <div style={{ marginTop: 32, padding: 20, borderRadius: 12, background: `${PDF_BRAND.accent}08`, border: `1px solid ${PDF_BRAND.accent}20`, textAlign: "center" }}>
                <a href="/pdf-tools/compress-pdf" style={{ color: PDF_BRAND.accent, textDecoration: "none", fontSize: 14, fontWeight: 700 }}>
            ...
            <Route path="/job-finder" element={<StudentPageWrapper title="Job Finder" hindi="जॉब फाइंडर"><JobFinder /></StudentPageWrapper>} />
