  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 80px" }} className="fade-in">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 40, overflowX: "auto", whiteSpace: "nowrap", paddingBottom: 8 }}>
        <a href="/" style={{ color: BRAND.textSecondary, textDecoration: "none", fontSize: 14 }}>All Tools</a>
      ...
      <div style={{ textAlign: "center", marginTop: 60 }}>
        <a href="/" style={{ color: BRAND.textSecondary, textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
          ← Back to All Tools
        </a>
      </div>
    </div>
